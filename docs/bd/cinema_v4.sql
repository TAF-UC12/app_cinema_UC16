...
INSERT INTO `cinema_v4`.`noticias` (`idnoticias`, `tituloNoticia`, `subtitulo`, `texto`, `dataPost`, `horaPost`, `autorPost`, `tipo`, `relac_games`, `relac_filmes`, `relac_series`, `img`, `destaque`, `imgDestaque`) VALUES (NULL, 'Entrevista: Quais novidades realmente importam em FIFA 19?', 'A diferença está nos detalhes', '<p>H&aacute; mais de 25 anos, a Electronic Arts tem o costume de lan&ccedil;ar <a href=\"http://br.ign.com/fifa-19/62809/news/fifa-19-e-confirmado-e-tem-cristiano-ronaldo-na-capa\">um novo game FIFA por ano</a>. E cada nova vers&atilde;o do simulador futebol&iacute;stico tem como miss&atilde;o principal superar a anterior, tanto em qualidade t&eacute;cnica e avan&ccedil;os tecnol&oacute;gicos como na receptividade dos f&atilde;s hardcore.</p>', '20180613', NULL, 1, 2, 7, NULL, NULL, 'fifa19_news1.jpg', 'on', 'fifa19_destaque.jpg');
